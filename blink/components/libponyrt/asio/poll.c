...
/*
undefined reference to `ponyint_asio_backend_init'
undefined reference to `ponyint_asio_backend_dispatch'
undefined reference to `ponyint_asio_backend_final'
undefined reference to `pony_asio_event_unsubscribe' 
*/
asio_backend_t* ponyint_asio_backend_init(){return NULL;}
DECLARE_THREAD_FN(ponyint_asio_backend_dispatch){return NULL;}
void ponyint_asio_backend_final(asio_backend_t* b){}
PONY_API void pony_asio_event_unsubscribe(asio_event_t* ev){}
